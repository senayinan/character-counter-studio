public class Main {
    ...
    public static void main(String[] args) {
        ...
        String myText = "If the product of two terms is zero then common sense says at least" +
        ...
        characterCounter.countCharacters(myText);
        //Bonus Mission 1
        /*String input = characterCounter.userInput();
